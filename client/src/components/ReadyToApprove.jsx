...
const ReadyToApprove = () => {
    return (
        <div className="flex flex-col items-center text-center pb-32 rounded-lg shadow-lg w-full md:w-3/4 mx-auto ">
            ...
            <button className=" bg-blue-500 text-white py-2 px-6 rounded-lg hover:bg-blue-700 transition duration-300">
                Approve the properties on wait 
            </button>
        </div>
    );
};

export default ReadyToApprove;
